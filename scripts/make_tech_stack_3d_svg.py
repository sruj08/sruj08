...
def generate_tech_stack_3d_svg(output_path="tech-stack-3d.svg"):
    ...
    svg.append('  .cat-title { font-family: monospace, Courier; font-size: 12px; font-weight: bold; }')
    svg.append('  .pill-bg { rx: 12px; ry: 12px; fill: #161b22; stroke: #30363d; stroke-width: 1px; }')
    svg.append('  .pill-text { font-family: monospace, Courier; font-size: 11px; fill: #c9d1d9; }')
    svg.append('</style>')
